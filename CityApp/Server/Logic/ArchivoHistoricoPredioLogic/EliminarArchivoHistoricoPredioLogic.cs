...
{
    public class EliminarArchivoHistoricoPredioLogic
    {
        ...
        private int IdArchivoHistoricoPredio;
        private ArchivoHistoricoPredio ArchivoHistoricoPredio;

        public EliminarArchivoHistoricoPredioLogic(CityAppContext cityAppContext, int idArchivoHistoricoPredio)
        {
            ArchivoHistoricoPredioQuerys = new ArchivoHistoricoPredioQuerys(cityAppContext);

            IdArchivoHistoricoPredio = idArchivoHistoricoPredio;
        }
        ...
        private Response<object> CargarArchivoHistoricoPredio()
        {
            ...
            Response<ArchivoHistoricoPredio> responseArchivoHistoricoPredio = ArchivoHistoricoPredioQuerys.SelectArchivoHistoricoPredioIdArchivoHistoricoPredio(IdArchivoHistoricoPredio);
