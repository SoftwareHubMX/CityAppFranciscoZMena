...
{
    public class ConsultarContactoMunicipioAppLogic
    {
        ...
        public ConsultarContactoMunicipioAppLogic(CityAppContext cityAppContext)
        {
        ...
        public Response<ContactoMunicipio> Consultar()
        {
            ...
            response = ContactoMunicipioQuerys.SelectLastContactoMunicipio();
