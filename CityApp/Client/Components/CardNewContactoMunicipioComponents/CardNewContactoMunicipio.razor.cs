...
using CityApp.Client.Logic.CardNewContactoMunicipioLogic;
...
namespace CityApp.Client.Components.CardNewContactoMunicipioComponents
{
    public partial class CardNewContactoMunicipio
    {
        ...
        private async void InsertarContacto()
        {
            ...
            InsertContactoMunicipio insertContactoMunicipio = new InsertContactoMunicipio(Cliente);
            response = await insertContactoMunicipio.Insert(Sesion.TokenAcceso, ContactoMunicipio);
            if (response.Status.Exito == 1)
            {
                idContactoMunicipio = response.Data;
                siguienteAtras();
            }
            else
            {
        ...
        {
            RedSocialMunicipio.IdContactoMunicipio = idContactoMunicipio;
