...
{
    public class CrearPatrulla
    {
        private HttpClient Cliente;
        public CrearPatrulla(HttpClient cliente)
        {
            Cliente = cliente;
        }

        public async Task<Response<object>> CrearPatrullaAsync(string token, Patrulla Patrulla)
        {
            Response<object> response = new Response<object>();

            string url = "Patrulla/CrearPatrulla";
