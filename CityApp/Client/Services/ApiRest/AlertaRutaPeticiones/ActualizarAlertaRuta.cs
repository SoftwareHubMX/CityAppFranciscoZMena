...
{
    public class ActualizarAlertaRuta
    {
        private HttpClient Cliente;
        public ActualizarAlertaRuta(HttpClient cliente)
        {
            Cliente = cliente;
        }

        public async Task<Response<object>> ActualizarAlertaRutaAsync(string token, AlertaRuta alertaRuta)
        {
            Response<object> response = new Response<object>();

            string url = "AlertaRuta/ActualizarAlertaRuta";
