...
{
    public class ConsultarDataSetIngresosYear
    {
        private HttpClient Cliente;
        public ConsultarDataSetIngresosYear(HttpClient cliente)
        {
            Cliente = cliente;
        }

        public async Task<Response<List<ChartData>>> ConsultarDataSetIngresosYearAsync(FechasDashBoard fechasDashBoard, string token)
        {
            Response<List<ChartData>> response = new Response<List<ChartData>>();

            string url = "DashBoard/ConsultarDataSetIngresosYear";
