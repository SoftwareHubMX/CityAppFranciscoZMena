...
{
    public class CorreoContadorAccesoReseteado
    {
        public static string GetCorreo()
        {
            string data = "<div style='width: 100%;'>" +
                                        "<div style='width: 100%; padding: 0; padding-bottom: 50px;'>" +
                                            "<p style='padding: 15px 90px; font-size: 30px; font-weight: 600; background-color: #cf131e; color: #fff; margin: 40px 0; margin-left: auto;'>Cuenta restaurada</p>" +
                                            "<p style='font-size: 25px; margin: auto; text-align: center;'>Hemos desbloqueado su cuenta, ya puede reintentar iniciar sesión, si no recuerda su contraseña, pruebe restaurarla</p>" +
                                        "</div>" +
